...
<head>
    ...
    <link href="css/code_generator/code-generator-form.css" rel="stylesheet" type="text/css">
        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                ...
                <div class="navbar nav_title" style="border: 0;">
                    <a href="index.html" class="site_title"><i class="fa fa-eye"></i> <span>ICN Monitoring</span></a>
                </div>
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    ...
                    <div class="menu_section">
                        <ul class="nav side-menu">
                            <li><a href="index.html"><i class="fa fa-home"></i> Home <span class="fa"></span></a>
                            </li>
                            <li><a href="codeGenerator.php"><i class="fa fa-cogs"></i> Code Generation <span class="fa"></span></a>
                            </li>
                            <li><a><i class="fa fa-pie-chart"></i> Statistics <span class="fa"></span></a>
                            </li>
                    ...
                    <form class="form-horizontal form-label-left input_mask" action="" method="post">
                        ...
                        <div class="form-group">
                            <div class="my-form-group">
                                ...
                                <div class="radio">
                                    <label>
                                        <input type="radio" class="flat" <?php echo $firstChecked; ?> name="iCheck" value="Visible"> Visible
                                    </label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input type="radio" class="flat" <?php echo $secondChecked; ?> name="iCheck" value="Invisible"> Invisible
                                    </label>
                                </div>
                            </div>
